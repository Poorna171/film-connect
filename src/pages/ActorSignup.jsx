...
const ActorSignup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setError('');
      setLoading(true);
      await signup(formData.email, formData.password, formData.fullName, formData.country, 'actor');
    ...
    <div className="min-h-screen bg-[#0A0F1C] flex">
        ...
        <div className="w-full max-w-md space-y-8">
          <div className="text-center">
            ...
            <p className="mt-3 text-gray-400">
              Create your professional profile as an actor
            </p>
          </div>
          ...
          <div className="text-center">
            <p className="text-gray-400">
              ...
              <Link to="/login/actor" className="text-cyan-400 hover:underline font-medium">
                Sign In
              </Link>
            </p>
          </div>
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        ...
        <div 
          ...
          style={{
            backgroundImage: "url('/images/actor-signup-bg.jpg')",
          }}
        >
        ...
        <div className="relative z-10 flex items-center justify-center p-12 w-full">
          <div className="max-w-lg text-center">
            <h3 className="text-3xl font-bold text-white mb-6">Your Acting Journey Begins</h3>
